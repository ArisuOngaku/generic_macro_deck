import {profileDirectory} from "./Config";
...
export default class Profile {
    ...
    constructor(quitFunction, obsController, name, data) {
    ...
    load() {
        ...
        this.keyboardUI.open();
    }

    unload() {
        this.keyboardUI.close();
    ...
    save() {
        fs.writeFileSync(path.resolve(profileDirectory, this.name + '.json'), JSON.stringify(this.serialize()));
    }
